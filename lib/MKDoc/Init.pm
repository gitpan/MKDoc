...
MKDoc::Init - MKDoc Initialization Framework
...
Under mod_perl, MKDoc::Init runs as a PerlInitHandler.

Under mod_cgi, MKDoc::Init runs before anything else.

See L<MKDoc::Init::Petal> for an example of initialization module.

...
You should really read L<MKDoc::Article::Overview> and then go through
L<MKDoc::Article::Install> if you haven't yet.
...
L<MKDoc> is part of this effort.
...
L<MKDoc> will try to invoke the $class->main() on each of the plugins until one
